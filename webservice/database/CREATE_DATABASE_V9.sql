...
CREATE  TABLE IF NOT EXISTS `tcc_gfx`.`residencias` (
  ...
  INDEX `FK_owner` (`user_id` ASC) ,
  INDEX `FK_distribuidora` (`distribuidora_id` ASC) ,
  CONSTRAINT `FK_owner`
    FOREIGN KEY (`user_id` )
...
CREATE  TABLE IF NOT EXISTS `tcc_gfx`.`medidas` (
  ...
  `inicio_medida` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP ,
